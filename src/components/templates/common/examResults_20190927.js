    ...
    */}
    ...
    <div className="row">
      ...
      */}
      ...
      <div className="col-10"><strong>AWARDED THE {certificate.name.toUpperCase()}</strong>
      <br />
      </div>

      <div className="col-2"><strong>AWARD:</strong></div>
      <div className="col-10"><strong>{certificate.additionalData.transcriptData[0].comStatement}</strong>
      <br />
      </div>

      <div className="col-4"><strong>NATIONAL PHYSICAL FITNESS AWARD:</strong></div>
      <div className="col-8"><strong>{certificate.additionalData.transcriptData[0].napfaStatement}</strong>
      <br />
      </div>

      <div className="col-4"><strong>CO-CURRICULAR ACTIVITIES GRADE:</strong></div>
      <div className="col-8"><strong>{certificate.additionalData.transcriptData[0].ccaStatement1}</strong></div>
      <div className="col-8"><strong>{certificate.additionalData.transcriptData[0].ccaStatement2}</strong>
      <br />
      </div>
    </div>
